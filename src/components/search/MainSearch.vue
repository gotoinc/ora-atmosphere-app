<template>
    <form
        ...
        class="search bordered relative w-full transition-all max-tab:static max-tab:ml-auto max-tab:!max-w-24"
    >
...
<style scoped>
    .search {
        ...
        &__wrap {
            @apply transition-all max-tab:invisible max-tab:absolute max-tab:left-1/2 max-tab:top-full max-tab:w-4/5 max-tab:-translate-x-1/2 max-tab:opacity-0;
        }
